document.addEventListener("DOMContentLoaded", () => {
  ...
  // Attach to the first button (Lock In) just like your snippet did
  ...
  // Also expose a global for the inline HTML onclick
  ...
  // Also expose submitPicks for the inline HTML onclick
